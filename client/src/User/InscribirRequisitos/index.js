...
import { ProgressBarRequisitos } from '../../Componentes/ProgressBarRequisitos';
function InscribirRequisitos() {
            ...
            <DivisionFlexHorizontal>
                ...
                <AsideDerechaNoFijoIns>
                  ...
                  <DivisionFlexVerticalAlignRight>
                    ...
                    <ProgressBarRequisitos target={70} current={30}/>
                    <HabilidadesBlandas param={2}/>
                    <ProgressBarRequisitos target={85} current={40}/>
                    <HabilidadesBlandas param={3}/>
                    <ProgressBarRequisitos target={50} current={20}/>
                  </DivisionFlexVerticalAlignRight>
...
export default InscribirRequisitos;
